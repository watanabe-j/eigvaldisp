...
By default, `Var.VRR()` internally calls `AVar.VRR_pfd()`. The function to be called can be chosen by providing the suffix of one of these functions as the argument `fun`; e.g., `Var.VRR(..., fun = "klv")` to use `AVar.VRR_klv()`.
...
X2 <- eigvaldisp:::rmvn(10, Sigma = Sigma2, sqrt_method = "chol_piv")
